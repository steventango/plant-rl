# Experiment E23 / Phase P0 — Constant 100 PPFD incubation
...
|---|---|---|---|
| Z1 (zone01) | `Constant1.json` | `ConstantAgent` (`constant_action: 1.0`) | `flash_photography: true`, `enforce_night: true`, `timezone: "Etc/GMT-2"`, `enable_cv_pipeline: false` |
...
```bash
python src/main_real.py -e "experiments/online/E23/P0/Constant1.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant2.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant3.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant4.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant5.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant6.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant7.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant8.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant9.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant10.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant11.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E23/P0/Constant12.json" -i 0 --deploy
```

Each zone is deployed independently via `compose.yml`. After the 6-day incubation completes (or earlier, if ready to hand off), stop the P0 runs and start the corresponding P1 configs once E23/P1 is created.
...
- [`../../E22/P0/README.md`](../../E22/P0/README.md) — prior incubation phase this one follows.
