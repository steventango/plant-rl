# Experiment E21 / Phase P0 — Constant 100 PPFD incubation
...
This phase runs from **transplant date (2026-08-04, DAS 7)** to **agent start (2026-08-10, DAS 12)** — 6 days of incubation. The configs are sized for **4 weeks** (`total_steps: 40320` = 28 days of 1-min env steps) so the same constant-100 policy can keep running indefinitely if the handoff is delayed.
...
```bash
python src/main_real.py -e "experiments/online/E21/P0/Constant1.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant2.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant3.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant4.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant5.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant6.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant7.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant8.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant9.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant10.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant11.json" -i 0 --deploy
python src/main_real.py -e "experiments/online/E21/P0/Constant12.json" -i 0 --deploy
```

Each zone is deployed independently via `compose.yml`. After the 6-day incubation completes (or earlier, if ready to hand off), stop the P0 runs and start the corresponding P1 configs once E21/P1 is created.
...
- [`../../E20/P0/README.md`](../../E20/P0/README.md) — prior incubation phase this one follows.
