...
class PlantSimulator(BaseEnvironment):
    def __init__(self):
        ...
        data_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "plant_area_data.csv")
    ...
    def compute_reward(self, next_state):  # episodic return would be ~ total gain in area
    ...
    def analyze_area_data(self): 
        ...
        for i in range(observed_area.shape[0]-1):
            ...
            # Assume constant amount of growth in the leaf's actual area during each time interval
