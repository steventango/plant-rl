...
def return_area_correlation(env):
    ...
    plt.legend()
    plt.savefig(os.path.dirname(os.path.abspath(__file__)) + '/plots/test_plant_simulator/return_area_correlation.png')
    plt.show()

def random_light_policy(env, off_prob=0.5):
    ...
    plt.ylabel('Reward')
    plt.legend()
    plt.savefig(os.path.dirname(os.path.abspath(__file__)) + '/plots/test_plant_simulator/reward_history_light-random.png')
    plt.show()
    ...
    plt.legend()
    plt.savefig(os.path.dirname(os.path.abspath(__file__)) + '/plots/test_plant_simulator/area_history_light-random.png')
    plt.show()
...
def interpolate_actual_area(env):   
    ...
    plt.savefig(os.path.dirname(os.path.abspath(__file__)) + '/plots/test_plant_simulator/projection_factor.png')
    plt.show()
