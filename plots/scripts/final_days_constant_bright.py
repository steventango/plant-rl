...
final_days_data = constant_bright_data[
    constant_bright_data["day_idx"].isin([13, 14, 15, 16])
]
...
plt.title(
    "Normalized Area for 'Constant Bright' Agent (Days 13, 14, 15, 16)", fontsize=14
)
...
plt.gca().xaxis.set_major_formatter(
    mdates.DateFormatter("%d-%H-%M", tz=pytz.timezone("America/Edmonton"))
)
