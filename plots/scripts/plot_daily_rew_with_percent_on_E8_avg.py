...
#%%
target_times = ["09:20", "09:30", "09:40", "09:50", "10:00"]
reward_data = []
for agent, group in df.groupby('agent'):
...
fig.suptitle(f"Percent Bright vs Change in Area (avg of first 5 obs)", fontsize=18)

plt.savefig(f"plots/outputs/grid_line_plots_E8_avg.png", dpi=300, bbox_inches='tight')
