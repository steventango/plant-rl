...
fig.suptitle("Percent Bright vs Change in Area (avg of first 5 obs)", fontsize=18)

plt.savefig("plots/outputs/grid_line_plots_E8_avg.png", dpi=300, bbox_inches='tight')
