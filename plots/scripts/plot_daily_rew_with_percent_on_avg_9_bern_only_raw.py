...
fig.suptitle(f"Percent Bright vs 24 hr change in raw area (avg of first 5 obs)", fontsize=18)
plt.savefig(f"plots/outputs/grid_line_plots_bern_only_9_avg.png", dpi=300)
