...
for target_str in ["09:20", "09:30", "09:40", "09:50", "10:00"]:
    ...
    for (day, agent), group in df.groupby(['day', 'agent']):
        ...
        if reward > 0:
            plot_data.append({'day': day, 'agent': agent, 'reward': reward, 'percent_action_1': percent_action_1})
    ...
    if num_days > 0:
        for i, day in enumerate(unique_days):
            ...
            ax.set_xlabel("Proportion Action == 1")
    ...
    fig.legend(by_label.values(), by_label.keys(),
            ...
            loc='upper right', bbox_to_anchor=(1.02, 1.0))  # push legend further right
    ...
    plt.savefig(f"plots/outputs/grid_line_plots_E8_{target_str}.png", dpi=300, bbox_inches='tight')
