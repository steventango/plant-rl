...
#     df.loc[group.index, 'mean_clean_area'] = group['mean_clean_area'] / first_obs_mean
    ...
    #%%
target_times = ['11:40', '11:50', '12:00', '12:10', '12:20']  # Target times for 12pm observations
reward_data = []
for agent, group in df.groupby('agent'):
...
fig.suptitle(f"Percent Bright vs Change in Area (avg of 5 obs centered on 12 pm)", fontsize=18)
plt.savefig(f"plots/outputs/grid_line_plots_all_12pm_avg.png", dpi=300)
