...
fig.suptitle("Percent Bright vs Change in Area (avg of 5 obs centered on 12 pm)", fontsize=18)
plt.savefig("plots/outputs/grid_line_plots_all_12pm_avg.png", dpi=300)
