...
# %%
df = pd.read_csv('/data/online/E6/P5/data.csv')
...
for (name, group_df) in df.groupby("environment.zone"):
    ...
    path = Path(f"/data/online/E6/P5/Spreadsheet-Poisson{name}/z{name}")
    # images
    ...
    #print(group_df['environment.zone'][0])
    #print(group_df.head(5).to_dict())
